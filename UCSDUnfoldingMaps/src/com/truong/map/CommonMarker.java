...
public abstract class CommonMarker extends SimplePointMarker {
	...
	/*
	 * For every click, if lastClicked is not null, set all markers visible, else, for all markers, if the cursor is in one marker, set all markers unvisible and set the Marker which has the cursor on it to visible
	 */
